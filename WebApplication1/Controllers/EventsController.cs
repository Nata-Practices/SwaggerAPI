...
public class EventsController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> AddEvent([FromBody] Model.Event newEvent)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateEvent(string id, [FromBody] Model.Event updatedEvent)
    {
