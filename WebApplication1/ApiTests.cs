...
using Xunit;
using static WebApplication1.Model;
...
public class ApiTests(WebApplicationFactory<Program> factory) : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Add100EventsTest()
    {
        ...
        var eventsFromDb = JsonSerializer.Deserialize<List<Event>>(responseContent);
    ...
    public async Task DeleteAllEventsTest()
    {
        ...
        var finalEventsFromDb = JsonSerializer.Deserialize<List<Event>>(finalResponseContent);
